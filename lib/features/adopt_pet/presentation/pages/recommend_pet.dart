...
class _RecommendPetState extends State<RecommendPet> {
                  ...
                  child: ListView(
                    children: <Widget>[
                      Column(
                        ...
                        children: [
                          const Text(
                            '1. Tienes expereiencia cuidando perros?',
                      ...
                      Column(
                        ...
                        children: [
                          const Text(
                            '2. Qué tipo de adiestramiento podra propocionarle a su perro ideal?',
                            style: TextStyle(fontWeight: FontWeight.bold),
                          ),
                          const SizedBox(
                            height: 10.0,
                      ...
                      Column(
                        ...
                        children: [
                          const Text(
                            '3. Qué tipo de paseos realizaria su perro ideal?',
                            style: TextStyle(fontWeight: FontWeight.bold),
                          ),
                          const SizedBox(
                            height: 10.0,
                      ...
                      Column(
                        ...
                        children: [
                          const Text(
                            '4. Cuánto tiempo durará el paseo?',
                            style: TextStyle(fontWeight: FontWeight.bold),
                          ),
                          const SizedBox(
                            height: 10.0,
                      ...
                      Column(
                        ...
                        children: [
                          const Text(
                            '5. Tamaño del perro ideal que podrá cuidar',
                            style: TextStyle(fontWeight: FontWeight.bold),
                          ),
                          const SizedBox(
                            height: 10.0,
                      ...
                      Column(
                        ...
                        children: [
                          const Text(
                            '6. Dato: todos los perros babean, porfavor elija que tanto puede babear su perro ideal:',
                            style: TextStyle(fontWeight: FontWeight.bold),
                          ),
                          const SizedBox(
                            height: 10.0,
                      ...
                      Column(
                        ...
                        children: [
                          const Text(
                            '7. Que tan seguido aseara a su perro ideal?',
                            style: TextStyle(fontWeight: FontWeight.bold),
                          ),
                          const SizedBox(
                            height: 10.0,
                      ...
                      Column(
                        ...
                        children: [
                          const Text(
                            '8. Necesita que su perro sea hipoalergeníco?',
                            style: TextStyle(fontWeight: FontWeight.bold),
                          ),
                          const SizedBox(
                            height: 10.0,
                      ...
                      Column(
                        ...
                        children: [
                          const Text(
                            '9. Que actitud debe tener su perro ideal?',
                            style: TextStyle(fontWeight: FontWeight.bold),
                          ),
                          const SizedBox(
                            height: 10.0,
                      ...
                      Column(
                        ...
                        children: [
                          const Text(
                            '10. Necesita que su perro ideal sea uno guardián?',
                            style: TextStyle(fontWeight: FontWeight.bold),
                          ),
                          const SizedBox(
                            height: 10.0,
                      ...
                      Column(
                        ...
                        children: [
                          const Text(
                            '11. Si su perro vivira con mascotas, porfavor seleccione que tipo de perro le gustaria tener?',
                            style: TextStyle(fontWeight: FontWeight.bold),
                          ),
                          const SizedBox(
                            height: 10.0,
                      ...
                      Column(
                        ...
                        children: [
                          const Text(
                            '12. Si su perro vivira con mascotas, porfavor seleccione que tipo de perro le gustaria tener?',
                            style: TextStyle(fontWeight: FontWeight.bold),
                          ),
                          const SizedBox(
                            height: 10.0,
  ...
  Future<List<String>> _sendFeatures() async {
    if (_selected1 != '' &&
        ...
        _selected12 != '') {
      var data =
          'perro, $_selected1, $_selected12, $_selected3, $_selected4, $_selected5, $_selected6, $_selected7, $_selected8, $_selected9, $_selected10, $_selected11, $_selected12';
      ...
      try {
        ...
        if (response.statusCode == 200 || response.statusCode == 201) {
          ...
          throw Exception('Failed to load breed pets');
        }
      } catch (e) {
      ...
      toast('Responda todas las preguntas');
      return [];
    }
  }
}
