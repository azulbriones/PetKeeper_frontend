...
class GetPostsByStatusUseCase {
  ...
  GetPostsByStatusUseCase(this.adoptPetRepository);
  Future<List<AdoptPet>> execute(String status) async {
    return await adoptPetRepository.getPostsByStatus(status);
  }
}
