...
class GetPostsByNewOwnerIdUseCase {
  final AdoptPetRepository adoptPetRepository;

  GetPostsByNewOwnerIdUseCase(this.adoptPetRepository);
  Future<List<AdoptPet>> execute(int newOwnerId) async {
    return await adoptPetRepository.getPostByNewOwnerId(newOwnerId);
  }
}
