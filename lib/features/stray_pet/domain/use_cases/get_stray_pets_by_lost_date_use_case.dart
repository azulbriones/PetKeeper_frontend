...
class GetStrayPetsByLostDateUseCase {
  final StrayPetRepository strayPetRepository;

  GetStrayPetsByLostDateUseCase(this.strayPetRepository);
  Future<List<StrayPet>> execute(DateTime lostedDate) async {
    return await strayPetRepository.getStrayPetsByLostDate(lostedDate);
  }
}
