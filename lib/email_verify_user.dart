...
class EmailVerifyUser extends StatefulWidget {
  const EmailVerifyUser({super.key});

  @override
  State<EmailVerifyUser> createState() => _EmailVerifyUserState();
}

class _EmailVerifyUserState extends State<EmailVerifyUser> {
